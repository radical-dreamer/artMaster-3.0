...
<fieldset>
	...
	<legend>Latest artWork Uploaded</legend>
<?php
	$con=mysql_connect ("localhost","root","");
mysql_select_db("artmaster",$con);
@$sql="select * from table_img order by id desc limit 20";
...
while(@$row=mysql_fetch_array($query))
{
 ...
 ?>
              ...
              <a href="image.php?id=<?php echo $id ?>" ><img src="image/<?php echo $image; ?>" class="img-other" width="140px" height="140px" ></a>
<?php
}
?>
</fieldset>
